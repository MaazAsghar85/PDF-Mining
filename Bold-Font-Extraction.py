...
def extract_content_by_font_size_and_style(pdf_path):
    ...
    # Output the results, apply condition for most common font size and boldness
    for text, font_size, style in content:
        if font_size != most_common_font_size or (font_size == most_common_font_size and style == "Bold"):
            print(f"Font Size: {font_size}, Style: {style}, Text: {text}")

if __name__ == "__main__":
    pdf_path = r'C:\Users\maaza\OneDrive\Desktop\pdfreader\pdfreader\data_2336.pdf'
